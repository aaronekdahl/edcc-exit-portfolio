# Edmonds Community College Exit Portfolio
...
#### Example Work
* [ART 225 - Introduction to Graphic Design: Example Work](documentation/example-work/art225-example.pdf)
* [ART 226 - Intermediate Graphic Design: Example Work](documentation/example-work/art226-example.pdf)
* [CIS 234 - Systems Design and Development: Example Work](documentation/example-work/cis234-example.pdf)
* [CIS 241 - Web Development I: Example Work (Live Site)](https://aaronekdahl.github.io/cis241-fp/)
* [CIS 242 - Web Development II: JavaScript and jQuery: Example Work (Live Site)](https://aaronekdahl.github.io/cis242-fp/)
* [CIS 244 - Web Development IV: Intro to Joomla! and SEO: Example Work (Live Site)](https://aaronekdahl-fp.cloudaccess.host/)
* [CIS 245 - Web Development V: Introduction to CSS: Example Work (Live Site)](https://aaronekdahl.github.io/cis245-fp/)
* [CIS 250 - Database Theory and Design: Example Work](documentation/example-work/cis250-example.pdf)
* [CIS 251 - Structured Query Language (SQL): Example Work](documentation/example-work/cis251-example.pdf)
* [CIS 253 - Application and Cloud Development Tools: Example Work](documentation/example-work/cis253-example.pdf)
